...
class VaccineCenterSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        VaccineCenter::create(['name' => 'Center 2', 'daily_limit' => 100]);
        VaccineCenter::create(['name' => 'Center 3', 'daily_limit' => 300]);
        VaccineCenter::create(['name' => 'Center 4', 'daily_limit' => 30]);
        VaccineCenter::create(['name' => 'Center 5', 'daily_limit' => 200]);
        VaccineCenter::create(['name' => 'Center 6', 'daily_limit' => 100]);
        VaccineCenter::create(['name' => 'Center 7', 'daily_limit' => 35]);
        VaccineCenter::create(['name' => 'Center 8', 'daily_limit' => 35]);
        VaccineCenter::create(['name' => 'Center 9', 'daily_limit' => 100]);
        VaccineCenter::create(['name' => 'Center 10', 'daily_limit' => 35]);
        VaccineCenter::create(['name' => 'Center 11', 'daily_limit' => 35]);
        VaccineCenter::create(['name' => 'Center 12', 'daily_limit' => 100]);
        VaccineCenter::create(['name' => 'Center 13', 'daily_limit' => 35]);
        VaccineCenter::create(['name' => 'Center 14', 'daily_limit' => 35]);
        VaccineCenter::create(['name' => 'Center 15', 'daily_limit' => 100]);
    }
}
